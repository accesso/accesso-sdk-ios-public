...
/// <blockquote>
/// Tip: Use <em>ExperiencePromoterProvider.shared</em> as a primary way to access the <code>AccessoExperiencePromoter</code>.
///
/// </blockquote>
/// <blockquote>
/// Important: <code>CoreProvider.configure(using:)</code> must be called with a valid configuration before using this class.
///
/// </blockquote>
/// See Also: <code>ExperiencePromoterProviding</code>
SWIFT_CLASS("_TtC25AccessoExperiencePromoter26ExperiencePromoterProvider")
@interface ExperiencePromoterProvider : NSObject
...
@interface ExperiencePromoterProvider (SWIFT_EXTENSION(AccessoExperiencePromoter)) <CLLocationManagerDelegate>
